...
/* New-Driver template - HID/USB Driver Implementation */
...
static void get_device_list(ohmd_driver* driver, ohmd_device_list* list)
{
	...
	while (cur_dev) {
		...
		strcpy(desc->driver, "Basic Template");
		strcpy(desc->vendor, "Template Driver");
		strcpy(desc->product, "Template");
